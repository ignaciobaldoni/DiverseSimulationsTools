...
@author: Rafael Probst; Edited by Ignacio Baldoni
...
widths  = np.arange(0.5,2.25,0.05)
heights = [750,800,850,950]
savePlot = True

for j in heights:
    for i in widths:
        folder = "./SiN_Waveguide\dispersion\dispersion_h{:.0f}nm".format(j)
        ...
        plt.title('Height = {:.0f} nm, width = {:.2f} nm'.format(j,i))
        plt.grid(True)
        plt.tight_layout()
