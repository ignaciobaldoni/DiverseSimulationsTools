...
if len(Waist_Scale) >= 3:
    ...
    for h in Taper_Length:
        ...
        Label = 'Taper length = %s m'%(np.round(h,3))
        plt.plot(Opt.Waist_len[k+0:k+2],Opt.SC_range[k+0:k+2],'-o',label=Label,alpha=(1-p*0.1))
        k = k + 2
        p = 0*p+1
    ...
    for h in Taper_Length:
        ...
        Label = 'Taper length = %s m'%(np.round(h,3))
        plt.plot(Opt.Waist_len[k+0:k+2],Opt.High_wavelength[k+0:k+2],'-o',label=Label,alpha=(1-p*0.1))
        k = k + 2
        p = 0*p+1
    ...
    for h in Taper_Length:
        ...
        Label = 'Taper length = %s m'%(np.round(h,3))
        plt.plot(Opt.Waist_len[k+0:k+2],Opt.Low_wavelength[k+0:k+2],'-o',label=Label,alpha=(1-p*0.1))
        k = k + 2
        p = 0*p+1
