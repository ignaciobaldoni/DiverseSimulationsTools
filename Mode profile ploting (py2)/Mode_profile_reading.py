...
Originally written for python 2, this python script takes the results from JCM
Wave and plots the mode profile output. 
It also implements the concept of EQUIVALENT AREA to estimate the radius params 
for the mode profile.
...
print('Careful, this code only works for Python 2')
...
def Mode_profile(plot_mode = True,
    ...
    if fit_mode == True:
        ...
        initial_guess = (1 , 0, 0, 3.2e-6, 3.2e-6)
...
if __name__ == "__main__":
    'Run the code'
    Mode_profile(plot_mode = True,fit_mode = True,plot_eqA = False,other_plots = True)